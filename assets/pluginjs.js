    ...
    $(document).ready(function() {
        ...
        Views.replyForm = Backbone.View.extend({
            ...
            setupModel: function(){
                ...
                var data_time_string = date_format.toDateString()+" - "+date_format.toTimeString().split(' GMT')[0];
                var date_time_string_html = "<br/><span style='font-size:10px;'>"+data_time_string+"</span>";
                var message_string = view.$el.find('textarea[name="post_title"]').val();
                
                if(message_string.startsWith('http://') || message_string.startsWith('https://')){
                	message_string = "<a href='"+message_string+"'>"+message_string+"</a>";
                }
                
                var decorated_message_format = message_string + date_time_string_html;
                
                view.model.set('post_content', decorated_message_format);
            },
